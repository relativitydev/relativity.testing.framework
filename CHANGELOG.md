...
### Changed
- Upgraded Newtonsoft.Json to fix vulnerability: https://security.snyk.io/vuln/SNYK-DOTNET-NEWTONSOFTJSON-2774678

## [7.2.2] - 2022-02-20

### Changed
- Added case to ObjectMappingService to map double value onto decimal property.

## [7.2.1] - 2022-01-27

### Changed
- Fixed issue with VersionResolveService handling ApplicationVersionRangeAttribute.
