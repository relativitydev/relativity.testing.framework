...
namespace Relativity.Testing.Framework.Tests.Extensions
{
	...
	public class ChoiceExtensionsFixture
	{
		...
		{
			NamedArtifact field = new NamedArtifact { ArtifactID = 12345 };
			NamedArtifact objectType = new NamedArtifact { ArtifactID = 12345 };
			NamedArtifact parent = new NamedArtifact { ArtifactID = 12345 };
