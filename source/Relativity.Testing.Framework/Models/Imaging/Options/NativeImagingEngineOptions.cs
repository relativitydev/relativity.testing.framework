namespace Relativity.Testing.Framework.Models.Imaging
{
	...
	public class NativeImagingEngineOptions
	{
		...
		/// </summary>
		/// <remarks>Corresponds to the Automatically detect and render color pages to JPEG option under Native Imaging Engine Options. This property is required if <see cref="ImageFormat"/> is set to <see cref="ImageFormat.Tiff"/>.</remarks>
		...
		/// </summary>
		/// <remarks>Corresponds to the Dithering Algorithm option in the Native Imaging Engine Options section. This property is required if <see cref="ImageFormat"/> is set to <see cref="ImageFormat.Tiff"/>.</remarks>
		...
		/// </summary>
		/// <remarks>Corresponds to the Dithering Threshold option under the Native Imaging Engine Options tab. This property is required if <see cref="DitheringAlgorithm"/> is set to <see cref="DitheringAlgorithm.Threshold"/>.</remarks>
